...
var GroupsRepository = /** @class */ (function () {
    function GroupsRepository() {
        this.groups = [];
    }
    GroupsRepository.getInstance = function () {
        if (!GroupsRepository.INSTANCE) {
            GroupsRepository.INSTANCE = new GroupsRepository();
        }
        return GroupsRepository.INSTANCE;
    };
    GroupsRepository.prototype.findByName = function (name) {
        var group = this.groups.find(function (group) { return group.name === name; });
        try {
    ...
    GroupsRepository.prototype.create = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        console.log(group);
                        return [4 /*yield*/, database_service_1.collections.groups.insertOne(group).then(function (result) {
                                console.log(result);
    ...
    GroupsRepository.prototype.list = function () { };
