...
var AuthenticateAccountController = /** @class */ (function () {
    function AuthenticateAccountController(authenticateAccountUseCase) {
        this.authenticateAccountUseCase = authenticateAccountUseCase;
        ("");
    }
    AuthenticateAccountController.prototype.handle = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, username, password;
